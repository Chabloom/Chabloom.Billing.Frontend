...
export const OidcConfiguration: UserManagerSettings = {
  ...
  redirect_uri: `${(window as any).__env__.REACT_APP_BILLING_FRONTEND_ADDRESS}/signin-oidc`,
  post_logout_redirect_uri: `${(window as any).__env__.REACT_APP_BILLING_FRONTEND_ADDRESS}/signout-oidc`,
  response_type: "code",
